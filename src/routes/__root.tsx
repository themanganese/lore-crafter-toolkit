  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 font-display text-2xl text-foreground">Path leads nowhere</h2>
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center gold-frame px-5 py-2 text-base tracking-wider text-gold-bright hover:bg-gold/10 transition-colors"
          >
            Return to Forge
          </Link>
        </div>
...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;600;700&family=IBM+Plex+Mono:wght@400;500&family=Pirata+One&display=swap",
      },
    ],
  }),
